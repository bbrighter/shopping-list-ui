...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
    get: (overrides?: HttpResponse<shoppinglist.MomentsResponse | any>) => (
...
export const listHandlers = {
    post: () => (http.post('/piid/:piid/list', () => (HttpResponse.json(
    { id: 2, items: [
    ...
    delete: () => (http.delete('/piid/:piid/list/:listId', ({ request }) => {
...
export const itemHandlers = {
    ...
    patchCheck: () => (http.patch('/piid/:piid/item/:itemId/check', () => (HttpResponse.json({})))),
    delete: () => (http.delete('/piid/:piid/item/:itemId', () => (HttpResponse.json({})))),
    patch: () => (http.patch('/piid/:piid/item/:itemId', () => (HttpResponse.json({})))),
}
...
export const productHandlers = {
    list: () => (http.get('/piid/:piid/products', () => (HttpResponse.json(
    { products: [
    ...
    patch: () => (http.patch('/piid/:piid/products/:id', () => (HttpResponse.json({})))),
    delete: () => (http.delete('/piid/:piid/products/:id', () => (HttpResponse.json({})))),
}
