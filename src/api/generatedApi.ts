// Code generated by the Encore v1.57.11 client generator. DO NOT EDIT.
...
export default class Client {
    ...
    public readonly shoppinglist: shoppinglist.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.shoppinglist = new shoppinglist.ServiceClient(base)
    }
...
export namespace shoppinglist {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.DeleteListAndMoveItems = this.DeleteListAndMoveItems.bind(this)
            this.DeleteProduct = this.DeleteProduct.bind(this)
            this.ForceDeleteList = this.ForceDeleteList.bind(this)
        ...
        public async DeleteListAndMoveItems(piid: string, listId: number): Promise<ListResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("DELETE", `/piid/${encodeURIComponent(piid)}/list/${encodeURIComponent(listId)}/move`)
            return await resp.json() as ListResponse
        }

        public async DeleteProduct(piid: string, id: number): Promise<void> {
            await this.baseClient.callTypedAPI("DELETE", `/piid/${encodeURIComponent(piid)}/products/${encodeURIComponent(id)}`)
        }

        public async ForceDeleteList(piid: string, listId: number): Promise<void> {
            await this.baseClient.callTypedAPI("DELETE", `/piid/${encodeURIComponent(piid)}/list/${encodeURIComponent(listId)}/force`)
        }

        public async GetMoments(piid: string): Promise<MomentsResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/piid/${encodeURIComponent(piid)}/moments`)
            return await resp.json() as MomentsResponse
        }

        public async GetProducts(piid: string): Promise<ProductListResponse> {
            // Now make the actual call to the API
        ...
        public async PatchProduct(piid: string, id: number, params: PatchProductParams): Promise<void> {
            await this.baseClient.callTypedAPI("PATCH", `/piid/${encodeURIComponent(piid)}/products/${encodeURIComponent(id)}`, JSON.stringify(params))
        }

        public async PostItem(piid: string, listId: number, productId: number): Promise<IdResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/piid/${encodeURIComponent(piid)}/list/${encodeURIComponent(listId)}/item/${encodeURIComponent(productId)}`)
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "hista-api-dpc2-Generated-TS-Client (Encore/v1.57.11)";
        }
