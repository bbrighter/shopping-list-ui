...
export namespace authentication {
	...
	export class ServiceClient {
		...
		constructor(baseClient: BaseClient) {
			...
			this.GetUsersForProductInstance =
				this.GetUsersForProductInstance.bind(this);
			this.Login = this.Login.bind(this);
			this.RemoveUserFromProductInstance =
				this.RemoveUserFromProductInstance.bind(this);
		}

		public async AddUserToProductInstance(
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/piid/${encodeURIComponent(productInstanceId)}/users/${encodeURIComponent(name)}`,
			);
		...
		public async GetUsersForProductInstance(
			productInstanceId: string,
		): Promise<UserListResponse> {
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI(
				"GET",
				`/piid/${encodeURIComponent(productInstanceId)}/users`,
			);
		...
		public async RemoveUserFromProductInstance(
			productInstanceId: string,
			name: string,
		): Promise<void> {
...
export namespace shoppinglist {
	...
	export class ServiceClient {
		...
		public async DeleteItem(piid: string, itemId: number): Promise<void> {
			await this.baseClient.callTypedAPI(
				"DELETE",
				`/piid/${encodeURIComponent(piid)}/item/${encodeURIComponent(itemId)}`,
			);
		}
		...
		public async DeleteList(
			piid: string,
			listId: number,
			params: DeleteListForceDeleteParam,
		): Promise<void> {
			...
			await this.baseClient.callTypedAPI(
				"DELETE",
				`/piid/${encodeURIComponent(piid)}/list/${encodeURIComponent(listId)}`,
				undefined,
				{ query },
			);
		}
		...
		public async DeleteProduct(piid: string, id: number): Promise<void> {
			await this.baseClient.callTypedAPI(
				"DELETE",
				`/piid/${encodeURIComponent(piid)}/products/${encodeURIComponent(id)}`,
			);
		}
		...
		public async GetMoments(piid: string): Promise<MomentsResponse> {
			...
			const resp = await this.baseClient.callTypedAPI(
				"GET",
				`/piid/${encodeURIComponent(piid)}/moments`,
			);
		...
		public async GetProducts(piid: string): Promise<ProductListResponse> {
			...
			const resp = await this.baseClient.callTypedAPI(
				"GET",
				`/piid/${encodeURIComponent(piid)}/products`,
			);
		...
		public async PostItem(
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/piid/${encodeURIComponent(piid)}/list/${encodeURIComponent(listId)}/item/${encodeURIComponent(productId)}`,
			);
		...
		public async PostOrGetList(piid: string): Promise<ListResponse> {
			...
			const resp = await this.baseClient.callTypedAPI(
				"POST",
				`/piid/${encodeURIComponent(piid)}/list`,
			);
			return (await resp.json()) as ListResponse;
		}

		public async PutItemByName(
			piid: string,
			listId: number,
			params: ItemNameParams,
		): Promise<ItemResponse> {
			// Now make the actual call to the API
			const resp = await this.baseClient.callTypedAPI(
				"PUT",
				`/piid/${encodeURIComponent(piid)}/list/${encodeURIComponent(listId)}/item`,
				JSON.stringify(params),
			);
	...
	constructor(baseURL: string, options: ClientOptions) {
		...
		if (!BROWSER) {
			this.headers["User-Agent"] =
				"hista-api-dpc2-Generated-TS-Client (Encore/v1.56.7)";
		}
