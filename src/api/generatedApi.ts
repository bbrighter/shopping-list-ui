...
export namespace shoppinglist {
    ...
    export class ServiceClient {
        ...
        public async CheckItem(piid: string, itemId: number, params: ItemCheckParams): Promise<void> {
            await this.baseClient.callTypedAPI("PATCH", `/piid/${encodeURIComponent(piid)}/item/${encodeURIComponent(itemId)}/check`, JSON.stringify(params))
        }
